...
var roleRegex = /^arn:aws:iam::role\/([a-zA-Z0-9+=,.@_-]{1,64})$/;
var regionRegex = /^[a-z]+-[a-z]+-[0-9]$/;
var externalIdRegex = /^[a-zA-Z0-9_+=,.@:\/-]{2,1024}$/;
var collapseRegex = /^JSON|concat|none$/;
var sourceRegex = /^arn:aws:((kinesis:[a-z]+-[a-z]+-[0-9]:[0-9]{12}:stream\/([a-zA-Z0-9_-]{1,128}))|(kinesis:[a-z]+-[a-z]+-[0-9]:[0-9]{12}:table\/[A-Za-z0-9_.-]\/stream\/[0-9A-Z_.:-]+))$/;
